...
mongoose.connect(
  'mongodb+srv://dan:' +
    ...
    '@node-rest-shop.pfakl.mongodb.net/<node-rest-shop>?retryWrites=true&w=majority',
  {
...
app.use('/products', productRoutes); //Requests that start with the first argument are handled by the second argument
